...
public class TerrenoGrid : MonoBehaviour
{
    ...
    [SerializeField] TerrenoGenerator terrenoGenerator;
    ...
    public void Update()
    {
        if (terrenoGenerator != null) terrenoGenerator.GenerateVegetation();
    }
    ...
    private void SpawnVegetation()
    {
        if (terrenoGenerator != null)
        {
            ...
            terrenoGenerator.GeneratePosition(gridPositions);
        }
    }
